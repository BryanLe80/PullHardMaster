...
export function RoutesPage() {
  ...
  function handleEdit(climb: Climb) {
    setForm({
      name: climb.name || '',
      grade: climb.grade,
      style: climb.style,
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Climbs</h1>
      ...
      <div className="space-y-4">
        {climbs.map((climb) => (
          <div key={climb.id} className="bg-white shadow overflow-hidden sm:rounded-lg">
            <div className="px-6 py-4">
              ...
              >
                <div>
                  <h3 className="text-lg font-medium text-gray-900">{climb.name || climb.grade}</h3>
              ...
              {climb.description && (
                <p className="mt-2 text-sm text-gray-600">{climb.description}</p>
              )}
                  ...
                  <div className="border-t pt-4">
                    ...
                    <dl className="mt-2 grid grid-cols-1 gap-x-4 gap-y-4 sm:grid-cols-2">
                      <div>
                        ...
                        <dd className="mt-1 text-sm text-gray-900">{climb.attempts}</dd>
                      </div>
                      <div>
                      ...
                      {climb.notes && (
                        <div className="sm:col-span-2">
                          ...
                          <dd className="mt-1 text-sm text-gray-900">{climb.notes}</dd>
                        </div>
                      )}
                    </dl>
                  </div>
                  ...
                  <div className="border-t pt-4">
                    ...
                    {uploadingPhotos && (
                      <div className="mb-4 flex items-center justify-center">
                        ...
                        <span className="ml-2 text-sm text-gray-600">Uploading photos...</span>
                      </div>
                    )}
